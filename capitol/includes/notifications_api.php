<?php
// capitol/includes/notifications_api.php
// Mirrors pharmacist/includes/notifications_api.php exactly, re-scoped
// to role='capitol'. Small JSON API backing the notification bell
// dropdown, called via fetch() from sidebar.php's JavaScript.

<?php
// staff/includes/notifications_api.php
// Small JSON API backing the notification bell dropdown. Called via
// fetch() from sidebar.php's JavaScript. Staff-only, session-scoped —
// every query is filtered by the logged-in staff member's own ID.

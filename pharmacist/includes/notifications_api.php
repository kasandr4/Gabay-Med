<?php
// pharmacist/includes/notifications_api.php
// Small JSON API backing the notification bell dropdown. Called via
// fetch() from sidebar.php's JavaScript. Pharmacist-only, session-scoped
// — every query is filtered by the logged-in pharmacist's own ID.
// Mirrors admin/includes/notifications_api.php and
// doctor/includes/notifications_api.php exactly, just re-scoped.
//
// Added 2026-07-27 — this portal's bell was pure UI-only (static sample
// data) until now, same gap admin's had before its own fix.

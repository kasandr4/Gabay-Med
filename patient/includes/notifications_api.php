<?php
// patient/includes/notifications_api.php
// Small JSON API backing the notification bell dropdown. Called via
// fetch() from sidebar.php's JavaScript. Patient-only, session-scoped —
// every query is filtered by the logged-in user's own ID.

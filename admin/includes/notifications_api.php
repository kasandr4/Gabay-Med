<?php
// admin/includes/notifications_api.php
// Small JSON API backing the notification bell dropdown. Called via
// fetch() from sidebar.php's JavaScript. Admin-only, session-scoped —
// every query is filtered by the logged-in admin's own ID.
// Mirrors doctor/includes/notifications_api.php exactly, just re-scoped.
//
// Added 2026-07-27 alongside the critical-stock notification trigger in
// pharmacist/dispense-actions.php — until now, admin/includes/sidebar.php's
// bell was pure UI-only (static sample data, see that file's history),
// so a create_notification() call for an admin had nowhere real to show
// up. This is what actually makes it visible.
